...
class UserManager:
    ...
    def update(self, id: int, data: dict) -> DBUser:
    ...
    def update_many(self, data: List[dict]) -> List[DBUser]:
    ...
    def delete_many(self, ids: List[int]) -> List[DBUser]:
