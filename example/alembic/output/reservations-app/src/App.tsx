...
function App() {
    ...
    const restaurant_columns = [
        ...
        // Delete Button, will call the delete endpoint and reload the data
        { field: "delete", headerName: "Delete", width: 100, renderCell: (params: GridCellParams<Restaurant>) => {
            return (
                <DeleteIcon onClick={() => {
                    ...
                    api.deleteRestaurantRestaurantDelete({ restaurantId: model.id as string }).then(() => {
                        fetchRestaurants();
                    });
                }} />
            );
