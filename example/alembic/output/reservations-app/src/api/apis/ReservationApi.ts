...
export class ReservationApi extends runtime.BaseAPI {
     ...
     */
    async createReservationAsyncReservationAsyncPostRaw(requestParameters: CreateReservationAsyncReservationAsyncPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Create Reservation Async
     */
    async createReservationAsyncReservationAsyncPost(requestParameters: CreateReservationAsyncReservationAsyncPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.createReservationAsyncReservationAsyncPostRaw(requestParameters, initOverrides);
     ...
     */
    async createReservationsAsyncReservationsAsyncPostRaw(requestParameters: CreateReservationsAsyncReservationsAsyncPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['reservation'] == null) {
            throw new runtime.RequiredError(
                'reservation',
     ...
     * Create Reservations Async
     */
    async createReservationsAsyncReservationsAsyncPost(requestParameters: CreateReservationsAsyncReservationsAsyncPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.createReservationsAsyncReservationsAsyncPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async deleteReservationAsyncReservationAsyncDeleteRaw(requestParameters: DeleteReservationAsyncReservationAsyncDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Delete Reservation Async
     */
    async deleteReservationAsyncReservationAsyncDelete(requestParameters: DeleteReservationAsyncReservationAsyncDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.deleteReservationAsyncReservationAsyncDeleteRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async deleteReservationsAsyncReservationsAsyncDeleteRaw(requestParameters: DeleteReservationsAsyncReservationsAsyncDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Delete Reservations Async
     */
    async deleteReservationsAsyncReservationsAsyncDelete(requestParameters: DeleteReservationsAsyncReservationsAsyncDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.deleteReservationsAsyncReservationsAsyncDeleteRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Query Reservation
     */
    async queryReservationReservationQueryPostRaw(requestParameters: QueryReservationReservationQueryPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Reservation>>> {
     ...
     * Query Reservation
     */
    async queryReservationReservationQueryPost(requestParameters: QueryReservationReservationQueryPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Reservation>> {
        const response = await this.queryReservationReservationQueryPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateReservationAsyncReservationAsyncPutRaw(requestParameters: UpdateReservationAsyncReservationAsyncPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['reservation'] == null) {
            throw new runtime.RequiredError(
                'reservation',
     ...
     * Update Reservation Async
     */
    async updateReservationAsyncReservationAsyncPut(requestParameters: UpdateReservationAsyncReservationAsyncPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.updateReservationAsyncReservationAsyncPutRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateReservationsAsyncReservationsAsyncPutRaw(requestParameters: UpdateReservationsAsyncReservationsAsyncPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['reservation'] == null) {
            throw new runtime.RequiredError(
                'reservation',
     ...
     * Update Reservations Async
     */
    async updateReservationsAsyncReservationsAsyncPut(requestParameters: UpdateReservationsAsyncReservationsAsyncPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.updateReservationsAsyncReservationsAsyncPutRaw(requestParameters, initOverrides);
        return await response.value();
    }
