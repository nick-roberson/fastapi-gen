...
export class ReviewApi extends runtime.BaseAPI {
     ...
     * Create Review Async
     */
    async createReviewAsyncReviewAsyncPostRaw(requestParameters: CreateReviewAsyncReviewAsyncPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Create Review Async
     */
    async createReviewAsyncReviewAsyncPost(requestParameters: CreateReviewAsyncReviewAsyncPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.createReviewAsyncReviewAsyncPostRaw(requestParameters, initOverrides);
     ...
     */
    async createReviewsAsyncReviewsAsyncPostRaw(requestParameters: CreateReviewsAsyncReviewsAsyncPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['review'] == null) {
            throw new runtime.RequiredError(
                'review',
     ...
     * Create Reviews Async
     */
    async createReviewsAsyncReviewsAsyncPost(requestParameters: CreateReviewsAsyncReviewsAsyncPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.createReviewsAsyncReviewsAsyncPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Delete Review Async
     */
    async deleteReviewAsyncReviewAsyncDeleteRaw(requestParameters: DeleteReviewAsyncReviewAsyncDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Delete Review Async
     */
    async deleteReviewAsyncReviewAsyncDelete(requestParameters: DeleteReviewAsyncReviewAsyncDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.deleteReviewAsyncReviewAsyncDeleteRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async deleteReviewsAsyncReviewsAsyncDeleteRaw(requestParameters: DeleteReviewsAsyncReviewsAsyncDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Delete Reviews Async
     */
    async deleteReviewsAsyncReviewsAsyncDelete(requestParameters: DeleteReviewsAsyncReviewsAsyncDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.deleteReviewsAsyncReviewsAsyncDeleteRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Query Review
     */
    async queryReviewReviewQueryPostRaw(requestParameters: QueryReviewReviewQueryPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Review>>> {
     ...
     * Query Review
     */
    async queryReviewReviewQueryPost(requestParameters: QueryReviewReviewQueryPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Review>> {
        const response = await this.queryReviewReviewQueryPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Update Review Async
     */
    async updateReviewAsyncReviewAsyncPutRaw(requestParameters: UpdateReviewAsyncReviewAsyncPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['review'] == null) {
            throw new runtime.RequiredError(
                'review',
     ...
     * Update Review Async
     */
    async updateReviewAsyncReviewAsyncPut(requestParameters: UpdateReviewAsyncReviewAsyncPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.updateReviewAsyncReviewAsyncPutRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateReviewsAsyncReviewsAsyncPutRaw(requestParameters: UpdateReviewsAsyncReviewsAsyncPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['review'] == null) {
            throw new runtime.RequiredError(
                'review',
     ...
     * Update Reviews Async
     */
    async updateReviewsAsyncReviewsAsyncPut(requestParameters: UpdateReviewsAsyncReviewsAsyncPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.updateReviewsAsyncReviewsAsyncPutRaw(requestParameters, initOverrides);
        return await response.value();
    }
