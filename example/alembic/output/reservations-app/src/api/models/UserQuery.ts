...
export function UserQueryFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserQuery {
    if (json == null) {
        return json;
    }
    return {
        ...
        'phoneNumber': json['phone_number'] == null ? undefined : PhoneNumber1FromJSON(json['phone_number']),
        'preferences': json['preferences'] == null ? undefined : Preferences1FromJSON(json['preferences']),
