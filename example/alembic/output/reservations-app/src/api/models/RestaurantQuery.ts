...
export function RestaurantQueryFromJSONTyped(json: any, ignoreDiscriminator: boolean): RestaurantQuery {
    if (json == null) {
        return json;
    }
    return {
        ...
        'cuisine': json['cuisine'] == null ? undefined : Cuisine1FromJSON(json['cuisine']),
        'rating': json['rating'] == null ? undefined : Rating1FromJSON(json['rating']),
        'priceRange': json['price_range'] == null ? undefined : PriceRange1FromJSON(json['price_range']),
    };
}
