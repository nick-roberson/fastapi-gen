...
function ReservationPage() {
    ...
    const reservation_columns = [
        ...
        { field: "delete", headerName: "Delete", width: 100, renderCell: (params: GridCellParams<Reservation>) => {
            return (
                <DeleteIcon onClick={() => {
                    ...
                    api.deleteReservationReservationDelete({ reservationId: model.id as string }).then(() => {
                        fetchReservations();
                    });
                }} />
            );
        ...
        try {
            let model = {
                ...
                reservationTime: parseField(
                    (document.getElementById("reservationTime") as HTMLInputElement).value,
                    "datetime"
                    ),
                ...
                specialRequests: parseField(
                    (document.getElementById("specialRequests") as HTMLInputElement).value,
                    "str"
                    ),
            ...
            <Box m={3}>
                ...
                <Grid container spacing={1}>
                    ...
                    <Grid item xs={12}>
                        ...
                        <Divider>
                            <Typography>
                                Loaded { reservation.length } Reservations
                            </Typography>
                        </Divider>
