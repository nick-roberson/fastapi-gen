...
> object create_groups_groups_post(body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Groups
        api_response = api_instance.create_groups_groups_post(body)
...
> object delete_groups_groups_delete(body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Groups
        api_response = api_instance.delete_groups_groups_delete(body)
...
> object update_groups_groups_put(body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Groups
        api_response = api_instance.update_groups_groups_put(body)
