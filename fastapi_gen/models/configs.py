...
from fastapi_gen.models.db import DBConfig
from fastapi_gen.models.enum import DatabaseTypes, FieldDataType
...
class ServiceInfo(BaseModel):
    ...
    description: MinStrType = "A service built with the FastAPI Gen fastapi_gen."
